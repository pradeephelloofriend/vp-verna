...
const forms = ({setRegCertData,cData}) => {
  ...
  return (
    <>
    <BreadcumbComponent pageInfo={{title:tempTitle,desc:"Forms/Download",img:b}}  />
   <FormComponent routeTitle={tempTitle} routeUri={router.query.uri} cDetailData={cData[0]}/>
