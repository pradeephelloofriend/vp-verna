...
import RtiComponent from '../../components/rti/RtiComponent';
...
const rti = ({setRegCertData,cData}) => {
  ...
  return (
    <>
      <BreadcumbComponent pageInfo={{title:tempTitle,desc:"Right to Information Act (RTI)",img:b}}  />
      <RtiComponent routeTitle={tempTitle} routeUri={router.query.uri} cDetailData={cData[0]}/>
    </>
  )
}
...
export default connect(null,mapDispatchToProps) (rti)