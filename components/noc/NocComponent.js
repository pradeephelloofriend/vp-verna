...
const { TabPane } = Tabs;
const NocComponent = ({tabKey,routeTitle,menuData,cDetailData,routeUri,setTabKey}) => {
              ...
              <div className="container-fluid  py-10 py-md-12">
                  <div className="row">
                      <div className='col-12'>
                          <div className='about-us-tab noc-tab'>
                                ...
                                {mData!==null?mData.childItems.edges.map((t,idx)=>
                                    <TabPane tab={t.node.label} key={t.node.uri}>
                                        <div className='page-content'>
                                            ...
                                            {crData!==null?
                                            <NocTabDetailComponent cDetailData={crData}/>
                                            :<SpinningComponent/>   }
                                        </div>
...
export default connect(mapStateToProps,mapDispatchToProps) (NocComponent)